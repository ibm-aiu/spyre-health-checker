...
var _ = BeforeSuite(func() {
	...
	Expect(os.Setenv("SPYRE_TLS_CERT", TestCert)).To(Succeed())
	Expect(os.Setenv("SPYRE_TLS_KEY", TestKey)).To(Succeed())
	Expect(os.Setenv("SPYRE_TLS_CA", TestCert)).To(Succeed()) // Use same cert as CA for self-signed
...
var _ = AfterSuite(func() {
	...
	Expect(os.Unsetenv("SPYRE_TLS_CERT")).To(Succeed())
	Expect(os.Unsetenv("SPYRE_TLS_KEY")).To(Succeed())
	Expect(os.Unsetenv("SPYRE_TLS_CA")).To(Succeed())
})
